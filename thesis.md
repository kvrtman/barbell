...
I am a **Concentrated Capital Allocator** operating with limited time and limited capital.
My edge is not information or speed. It is **extreme focus, patience, and the willingness to hold through the period where the market is wrong**.
I do not diversify for its own sake. I take two positions and know them cold.

## Structure

### The Anchor — extreme stability
**RL Commercial REIT (RCR)** · Target: **10,000 shares** · Held: 7,817

- Job: print quarterly cash, forever. Nothing else.
- ₱0.11/share/quarter (₱0.44–0.45 annualized), ~6.1% yield at ₱7.30.
- Sponsor (Robinsons Land) keeps injecting assets: 2025 revenue +35%, earnings +71%. The vault gets deeper without me adding a peso.
- The anchor is never sold to fund the engine. Its *output* funds the engine.
...
Written down now, while calm, so future-me can't rationalize:

1. A **common-share** capital raise priced below book — management monetizing my dilution instead of pref/debt/asset recycling.
2. COD slipping past **mid-2027** for both farms — the construction story becoming a permanent construction story.
3. First-year generation materially below plan (capacity factor persistently < ~28%) — the assets underperforming their contracts.
4. RCR cutting its dividend — the anchor cracking (sponsor pipeline stalling, occupancy breaking down).
